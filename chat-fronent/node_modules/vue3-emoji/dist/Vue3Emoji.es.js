import { defineComponent as W, ref as k, computed as se, watchEffect as X, onMounted as Z, onBeforeUnmount as Q, openBlock as j, createElementBlock as h, normalizeClass as m, unref as n, normalizeStyle as Y, createElementVNode as w, toDisplayString as K, Fragment as A, renderList as N, createCommentVNode as V, watch as _e, renderSlot as P, createTextVNode as B, withDirectives as I, createBlock as M, vShow as O, isRef as R, vModelText as H } from "vue";
const S = {
...
}, de = "PollUp-module__pollup___MaX-h", fe = "PollUp-module__active___Byv7D", b = {
  pollup: de,
  ...
  active: fe
}, ke = (e = 13, _) => _.filter((o) => o.unicode_version ? !(Number.parseInt(o.unicode_version) > e) : !0), he = (e, _ = {}, o = 11, g = [], p = {}) => {
  const c = {}, y = { ...e, ...p };
  for (const r in y)
...
}, xe = /* @__PURE__ */ w("p", { sytle: "margin:0 5px;" }, "\u6700\u8FD1\u4F7F\u7528", -1), ze = ["onClick", "title", "innerHTML"], Se = ["onClick", "title", "innerHTML"], qe = ["title", "onClick"], G = /* @__PURE__ */ W({
  __name: "PollUp",
  props: {
    size: null,
    theme: null,
  ...
  setup(e, { emit: _ }) {
    const o = e, g = {
      ...
      light: "&#127995;",
      none: ""
    }, p = me, c = ce, y = ge, r = [], d = k("Smileys & Emotion"), a = k(), u = k(), E = he(p, o.optionsName, o.unicodeVersion, o.disableGroup, o.customTab), x = k(be("emoji-recent") || null), T = k({}), q = k(), C = k(), t = se(() => x.value && x.value.recent || []), s = (i) => {
    ...
    return X(() => {
      ...
      n(d) === "recent" ? (j(), h("div", {
        key: 0,
        class: m(n(b)["tab-name"])
      }, [
        xe,
        w("a", {
          class: m(n(b)["delete-recent"]),
          onClick: ee
        }, "\u5220\u9664\u6240\u6709\u9009\u9879", 2)
      ], 2)) : (j(), h("p", {
        key: 1,
      ...
      w("div", {
        class: m(n(b)["emoji-container"]),
        ref_key: "container",
        ref: C
      }, [
        n(d) === "recent" ? (j(!0), h(A, { key: 0 }, N(n(t), (v, l) => (j(), h("div", {
          class: m(n(b)["emoji-container-item"]),
          key: l,
          onClick: (ie) => U(v),
          title: v.name,
          innerHTML: s(v)
        }, null, 10, ze))), 128)) : (j(!0), h(A, { key: 1 }, N(n(E)[n(d)], (v, l) => (j(), h("div", {
          class: m(n(b)["emoji-container-item"]),
          key: l,
          onClick: (ie) => U(v),
          title: v.name,
      ...
      w("div", {
        class: m(n(b)["tab-container"]),
        ref_key: "tabcontainer",
        ref: q
      }, [
        e.needLocal ? (j(), h("div", {
          key: 0,
          class: m([n(b)["tab-item"], n(d) === "recent" ? n(b).active : ""]),
          onClick: f[0] || (f[0] = (v) => F("recent"))
        }, " \u{1F525} ", 2)) : V("", !0),
        (j(), h(A, null, N(r, (v) => w("div", {
          class: m([n(b)["tab-item"], v === n(d) ? n(b).active : ""]),
          title: v,
          key: v,
          onClick: (l) => F(v)
        }, K(e.customIcon && e.customIcon[v] ? e.customIcon[v] : n(E)[v][0].emoji), 11, qe)), 64))
      ], 2)
    ], 6));
  }
}), Ce = ["placeholder", "rows", "cols"], Ee = ["placeholder"], L = /* @__PURE__ */ W({
  __name: "V3Emoji",
  props: {
    size: { default: "mid" },
    ...
    skin: { default: "none" },
    recent: { type: Boolean, default: !1 },
    defaultSelect: { default: "Smileys & Emotion" },
    fulldata: { type: Boolean, default: !1 },
  ...
  setup(e, { expose: _, emit: o }) {
    const g = e, p = k(g.modelValue), c = k(), y = k(), r = k(), d = k(0), a = k(0), u = k(!1), E = (t) => {
      let s = t.target;
      if (s) {
      ...
      var s;
      g.manualClose || !((s = c.value) != null && s.contains(t.target)) && E(t) && (u.value = !1, o("close"));
    }, T = () => {
      u.value = !1;
    }, q = (t) => {
      if (g.textArea) {
      ...
      g.textArea && (g.inputType === "textarea" ? (d.value = y.value.selectionStart, a.value = y.value.selectionEnd) : (d.value = r.value.selectionStart, a.value = r.value.selectionEnd)), t && !g.manualClose && (u.value = !1);
    };
    return _({
      closePop: T
    }), X(() => {
      ...
      id: "EmojiItem",
      class: m(n(S)["emoji-item"]),
      ref_key: "EmojiEl",
      ref: c
    }, [
      e.textArea ? e.inputType === "textarea" ? (j(), h("div", {
        key: 1,
        class: m(n(S)["emoji-textarea"])
      }, [
        I(w("textarea", {
          "onUpdate:modelValue": s[1] || (s[1] = (z) => R(p) ? p.value = z : null),
          ref_key: "textarea",
          ref: y,
          ...
          onBlur: C,
          onFocus: C,
          style: Y({ resize: e.textAreaOption.resize })
        }, null, 44, Ce), [
          [H, n(p)]
        ]),
        w("div", {
          class: m(n(S)["emoji-textarea-pollup-container"])
        }, [
          w("div", {
            onClick: s[2] || (s[2] = (z) => u.value = !n(u)),
            class: m(n(S)["emoji-textarea-open-btn"])
          }, [
            P(t.$slots, "default", {}, () => [
              B("\u{1F600}")
            ])
          ], 2),
          n(u) && e.textArea || e.keep ? I((j(), M(G, {
            key: 0,
            onClickEmoji: q,
            size: e.size,
            theme: e.theme,
        ...
        key: 2,
        class: m(n(S)["emoji-input"])
      }, [
        I(w("input", {
          "onUpdate:modelValue": s[3] || (s[3] = (z) => R(p) ? p.value = z : null),
          ref_key: "inputArea",
          ref: r,
          placeholder: e.textAreaOption.placeholder,
          onBlur: C,
        ...
        key: 0,
        class: m(n(S)["emoji-container"])
      }, [
        w("div", {
          class: m(n(S)["emoji-container-open-btn"]),
          onClick: s[0] || (s[0] = (z) => u.value = !n(u))
        }, [
          P(t.$slots, "default", {}, () => [
            B("\u{1F600}")
          ])
